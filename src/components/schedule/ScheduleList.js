  ...
  return (
    <div className="schedule_list_container">
      <div className="schedule_list_box">
        ...
        {/* 8일 스케줄 */}
        <div
          className={active ? '8th_schedule_list' : 'schedule_list_none'}
          data-aos="fade-up"
          data-aos-duration="2000"
        >
          <div className="schedule_list_card">
            <div className="card_content">
              <span className="schedule_name">
                동아리 박람회
                <br />
              </span>
              <div className="sl_location">
                <img
                  src="./images/imgSchedule/marker.png"
                  alt="location marker"
                />
                <span className="sl_location">
                  &nbsp;잔디밭
                  <br />
                </span>
              </div>
        ...
        {/* 9일 스케줄 */}
        <div
          className={active ? 'schedule_list_none' : '9th_schedule_list'}
          data-aos="fade-up"
          data-aos-duration="2000"
        >
          <div
            className="schedule_list_card"
            data-aos="fade-up"
          ...
          >
            <div className="card_content">
              ...
              <span className="sl_time">09:00 - 17:00</span>
            </div>
          </div>
